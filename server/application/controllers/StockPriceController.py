...
stock_price_controller = Blueprint('stock_price_controller', __name__, url_prefix='/api/stock_price')


@stock_price_controller.route('/historical_price/all', methods=['GET'])
@authenticate
...
@stock_price_controller.route('/historical_price', methods=['GET'])
@authenticate
...
@stock_price_controller.route('/market_info', methods=['GET'])
@authenticate
...
@stock_price_controller.route('/calculate', methods=['GET'])
# @authenticate
...
@stock_price_controller.route('/notification', methods=['GET'])
# @authenticate
# def calculate(current_user):
def notification():
    """[summary]
